...
def mesher2D(file, gmshBinFile, dataPath, outputPath, h, generateCohesiveElements):
    # Get the start time
    t1 = time.time()
    ...
    os.system(f'gmsh2alya.pl {outputPath}/{file}_2d --bulkcodes --bcs=boundaries --out {outputPath}{file}')
